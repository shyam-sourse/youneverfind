...
# --- Configuration ---
# Set these in .env to use your own server's channels. Leave as 0 to disable.
SERVER_COUNT_CHANNEL_ID = int(os.getenv("SERVER_COUNT_CHANNEL_ID", "0")) or None
USER_COUNT_CHANNEL_ID = int(os.getenv("USER_COUNT_CHANNEL_ID", "0")) or None

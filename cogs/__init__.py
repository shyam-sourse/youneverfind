...
from .commands.application import StaffApplication
from .commands.staffmanager import StaffManager
from .commands.aiautomod import AIAutoMod
from .commands.aitask import AITask
from .commands.aistaff import AIStaff
from .commands.aikeys import AIKeys
from .commands.aisupport import AISupport
from .commands.aiwelcome import AIWelcome
from .commands.aiinsights import AIInsights
from .commands.advsecurity import AdvancedSecurity
...
from .commands.boostcolor import BoostColor
from .commands.blacktea import BlackTea
...
from .zyrox.boostcolor import _boostcolor
...
from .zyrox.owner import _owner
from .zyrox.honeypot import _honeypot
from .zyrox.leaderboard import _leaderboard
...
async def setup(bot: zyrox):
  cogs_to_load = [
        ...
        AntiWebhookDelete, AntiSpam, AntiCaps, AntiLink, AntiInvite, AntiMassMention, Stats, Status, NoPrefix, FilterCog, AutoReaction, AutoReactListener, Ban, Unban, Mute, Unmute, Lock, Unlock, Hide, Unhide, Kick, Warn, Role, Message, Moderation, TopCheck, Snipe, Global, QR, VanityRoles, ReactionRoles, Messages, TranslateCog, FastGreet, Jail, inviteTracker,Counting,AI,Monitor, BoostColor, BlackTea, StaffApplication, StaffManager, AdvancedSecurity, AIAutoMod, AITask, AIStaff, AIKeys, AISupport, AIWelcome, AIInsights, AIKeys, AISupport, AIWelcome, AIInsights
    ]
 ...
 # await bot.add_cog(Map(bot))
  ...
  await bot.add_cog(_boostcolor(bot))
  ...
  await bot.add_cog(_honeypot(bot))
